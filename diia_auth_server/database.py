...
from diia_auth_server.config import db_option
from diia_auth_server.background import run_async
from diia_auth_server.logger import get_logger
from diia_auth_server.models.base import BaseModelMixin
...
class DatabaseManager:
    ...
    def initialize(self, db_engine: Engine=None, scope_function: Callable = None):
        ...
        # Also I can't just do `from diia_auth_server.models import *` here, because in py3, the * is only
...
def _package_contents(package_name):
    """
    Given a package name ('diia_auth_server.models') will return all the modules in that package
...
def import_all_models():
    ...
    """
    for full_module_name in _package_contents('diia_auth_server.models'):
