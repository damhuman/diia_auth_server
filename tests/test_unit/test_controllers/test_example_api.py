...
class TestHttpGetAllUnitTestCase:
    @asynctest.patch('diia_auth_server.models.example.Example.get_all')
    @asynctest.patch('diia_auth_server.controllers.example_api.transactional_session')
...
class TestHttpGetByIdUnitTestCase:
    @asynctest.patch('diia_auth_server.models.example.Example.get_by_id')
    @asynctest.patch('diia_auth_server.controllers.example_api.transactional_session')
